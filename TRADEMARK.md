...
**Status:** "Caputchin" is a common-law trademark held through continuous use in commerce. Our enforcement layer is common-law trademark plus these guidelines plus the trademark-non-grant clause in Apache-2.0 §6. We can send cease-and-desist letters and file platform takedowns.
...
The Apache-2.0 license under which this code is distributed grants no rights to use the marks (§6).

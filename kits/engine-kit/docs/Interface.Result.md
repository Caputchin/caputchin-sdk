...
| ------ | ------ | ------ | ------ |
| <a id="passed"></a> `passed` | `readonly` | `boolean` | The engine's own pass decision from the terminal state (e.g. a score threshold or goal reached). `toRun` ANDs this with the non-truncated guard before emitting the Verdict. |

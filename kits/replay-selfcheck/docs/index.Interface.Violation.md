...
A single determinism violation found during [selfCheck](index.Function.selfCheck.md). `kind`
...
| <a id="kind"></a> `kind` | `readonly` | [`ViolationKind`](index.TypeAlias.ViolationKind.md) | Which determinism invariant the run violated. |

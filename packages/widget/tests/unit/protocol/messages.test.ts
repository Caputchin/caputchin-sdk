...
describe('isIframeToWidget', () => {
  ...
  it('accepts manifest carrying languages.presets', () => expect(isIframeToWidget({ kind: 'manifest', seq: 0, gameId: 'g', preferredLayout: null, preferredWidth: null, preferredHeight: null, languages: { presets: { en: { _iso: 'en', _default: true, hello: 'Hi' } } } })).toBe(true));

...
> **defineEngine**\<`S`, `A`, `C`, `V`\>(`def`): [`EngineDef`](index.Interface.EngineDef.md)\<`S`, `A`, `C`, `V`\>
...
| Parameter | Type |
| ------ | ------ |
| `def` | [`EngineDef`](index.Interface.EngineDef.md)\<`S`, `A`, `C`, `V`\> |

## Returns

[`EngineDef`](index.Interface.EngineDef.md)\<`S`, `A`, `C`, `V`\>

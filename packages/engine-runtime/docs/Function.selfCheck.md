...
> **selfCheck**\<`C`\>(`run`, `cases`, `opts?`): `Promise`\<[`SelfCheckReport`](Interface.SelfCheckReport.md)\>
...
| Parameter | Type |
| ------ | ------ |
| `run` | [`RunFn`](TypeAlias.RunFn.md)\<`C`\> |
| `cases` | readonly [`SelfCheckCase`](Interface.SelfCheckCase.md)\<`C`\>[] |
| `opts` | [`SelfCheckOptions`](Interface.SelfCheckOptions.md) |

## Returns

`Promise`\<[`SelfCheckReport`](Interface.SelfCheckReport.md)\>

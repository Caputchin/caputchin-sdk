...
| ------ | ------ | ------ |
| <a id="config"></a> `config` | [`ResolvedConfig`](Interface.ResolvedConfig.md) \| `null` | - |
| <a id="locale"></a> `locale` | [`ResolvedLocale`](Interface.ResolvedLocale.md) \| `null` | - |
...
| <a id="skin"></a> `skin` | [`ResolvedSkin`](Interface.ResolvedSkin.md) \| `null` | - |

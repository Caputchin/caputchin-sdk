...
exporting a function of this shape under the name [RUN\_EXPORT\_NAME](https://github.com/Caputchin/caputchin-sdk/tree/main/packages/replay-contract):
...
- `config` is the server-supplied [ReplayConfig](https://github.com/Caputchin/caputchin-sdk/tree/main/packages/replay-contract) (server round-setup,
...
| ------ | ------ |
| `C` | [`ReplayConfig`](https://github.com/Caputchin/caputchin-sdk/tree/main/packages/replay-contract) |
